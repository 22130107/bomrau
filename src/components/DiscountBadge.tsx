...
export function DiscountBadge({ discount }: DiscountBadgeProps) {
  return (
    <div className="items-center flex font-bold justify-center absolute w-[50px] md:w-[60px] h-[50px] md:h-[60px] top-0 right-0 text-white text-[18px] md:text-[22px] tracking-[0.22px] leading-[24px] md:leading-[30px] p-1 z-[2] animate-blink-badge font-[family-name:var(--font-nunito)]">
      ...
      <span className="block text-[rgb(254,239,199)] text-[14px] md:text-[16px] leading-[18px] md:leading-[22px]">%</span>
    </div>
  );
}
