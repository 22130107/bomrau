  ...
  return (
    <li className="list-none w-full md:w-[calc(33.333%-22px)]">
      <article className="border flex flex-col size-full relative bg-[rgb(2,6,23)] rounded-br-[1.25rem] border-[rgb(253,230,138)] rounded-tl-[1.25rem] pt-4 pr-4 pb-6 pl-4">
        <div className="font-medium text-[rgb(251,191,36)] text-[18px] md:text-[24px] leading-[28px] md:leading-[38.4px] font-[family-name:var(--font-nunito)]">
          {name}
        </div>
        ...
        <div className="flex flex-col grow text-center pt-4 pb-4">
          <div className="border-t text-center mt-[12px] pt-3 border-dashed border-t-[rgba(251,191,36,0.4)]">
            <span className="font-bold text-[rgb(251,191,36)] text-[16px] md:text-[20px] pr-2 font-[family-name:var(--font-nunito)]">
              {formatPrice(price)}
            </span>
            <span className="font-medium line-through text-[rgba(238,238,238,0.6)] text-[12px] md:text-[14px] font-[family-name:var(--font-nunito)]">
        ...
        <Link href={`/shopping/${id}`} className="items-center flex font-bold justify-center mx-auto mt-auto max-w-full w-[160px] md:w-[200px] h-10 bg-[rgb(202,138,4)] hover:bg-[rgb(251,191,36)] rounded-br-xl rounded-tl-xl text-[14px] md:text-[18px] transition-colors text-black">
          CHI TIẾT
        </Link>
      </article>
    </li>
